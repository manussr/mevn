...
<script>
    //Recordar mandar el token en cada petición que se haga 
    //Para si el usuario con ese token es valido o no  
    //para hacer ese tipo de acción
    ...
    export default {
        data(){
            return{
                ...
                search:'',
                categorias:[],
                //La información en los headers debe conincidir con los modelos descritos en 
                //el backend, precisamente en models/
                headers: [
